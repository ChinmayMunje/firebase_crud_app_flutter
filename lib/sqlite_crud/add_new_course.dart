...
class SQLAddNewCourse extends StatefulWidget {
  const SQLAddNewCourse({Key key}) : super(key: key);

  @override
  _SQLAddNewCourseState createState() => _SQLAddNewCourseState();
}

class _SQLAddNewCourseState extends State<SQLAddNewCourse> {
  ...
  Future<void> addCourse(String courseName, String courseImg,
      String courseDuration, String coursePrice, String courseLink) async {
    await SQLHelper.addNewCourse(
        courseName, courseImg, courseDuration, coursePrice, courseLink);
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      addCourse(courseName, courseImgUrl, courseDuration, coursePrice, courseLink);
                      clearText();
                    });
                  },
